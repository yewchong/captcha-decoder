...
public class AspriseOcrRecognizerUsingTraverseSplitterTest {
	...
	public static void main(String[] args) {
		Injector injector = Guice.createInjector(new ImageFileReaderModule(),
				...
				new TraverseSplitterModule(), new AspriseOcrRecognizerModule());
		...
		for (int count = 0; count < 16; count++) {
			BufferedImage vImage = reader.read(new File(Constant.PATH_FOLDER_ORIGINAL + "src"
					+ count + ".jpg"));
